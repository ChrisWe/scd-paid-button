...
use Shopware\Plugins\ViisonSCDPaidButton\Subscribers;

/**
 * @copyright Copyright (c) 2017, VIISON GmbH
 */
final class Shopware_Plugins_Backend_ViisonSCDPaidButton_Bootstrap extends ViisonCommon_Plugin_BootstrapV4
{
    /**
     * @return array
     */
    ...
    private function loadPlugin()
    {
        ...
        $this->get('loader')->registerNamespace(
            'Shopware\Plugins\ViisonSCDPaidButton',
            $this->Path()
        );
        ...
        $subscribers = [
            ...
            new ViisonCommonSubscribers\ViewLoading($this, 'ViisonSCDPaidButton')
        ];
